...
public class AdminProviderController {
    ...
    public ResponseEntity<APIResult<ProviderApproveResponse>> approveProvider(@PathVariable("partnerId") Long providerId) {
    ...
    public ResponseEntity<APIResult<ProviderApproveResponse>> stopProvider(@PathVariable("partnerId") Long providerId) {
