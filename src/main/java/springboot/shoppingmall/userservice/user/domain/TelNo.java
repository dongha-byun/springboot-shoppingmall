...
import static springboot.shoppingmall.userservice.user.domain.TelNoRegexConstants.TEL_NO_REGEX_010;
import static springboot.shoppingmall.userservice.user.domain.TelNoRegexConstants.TEL_NO_REGEX_ANOTHER;
