...
class OrderFinderTest {
    ...
    void findOrderById() {
        // given
        Order order = orderRepository.save(new Order(user, product, 20, delivery, OrderStatus.READY));
    ...
    void findOrderByInvoiceNumber() {
        ...
        Order order = orderRepository.save(new Order(user, product, 20, delivery, OrderStatus.READY, invoiceNumber));
